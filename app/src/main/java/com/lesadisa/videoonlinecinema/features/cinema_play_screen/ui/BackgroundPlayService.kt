...
private const val MEDIA_URL =
    "https://traffic.libsyn.com/secure/adbackstage/ADB162-1.5.mp3?dest-id=2710847"
...
class BackgroundPlayService : Service() {
    ...
    private lateinit var mediaObj: CinemaDomainModel //??? object that can hold details for the playing item, title/url/etc
    ...
    // метод обновления проигрывателя, используемый вместе со списком медиа-элементов
    fun updatePlayer(media: CinemaDomainModel) {

        this.mediaObj = media
        val mediaItem = MediaItem.fromUri(mediaObj.video)
